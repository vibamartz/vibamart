      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {products.length > 0 ? (
          ...
          >
            ...
            <Link 
              to="/products"
              className="inline-flex items-center gap-3 bg-primary text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-primary-hover transition-all shadow-xl shadow-blue-100"
            >
