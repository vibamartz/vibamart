...
export default function Home() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-20 pt-2 sm:pt-4">
      ...
      {/* 0. Top 3 Equal-Sized Cards (VIBA, Deal 259, REWARDS) */}
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-3 gap-3 sm:gap-5 w-full min-w-0">
          {/* Card 1: VIBA */}
          <motion.div
            whileTap={{ scale: 0.97 }}
          ...
          >
            <div className="w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center shrink-0">
              ...
              >
                <defs>
                  <linearGradient id="deal259GradDesk" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          >
            <div className="w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center shrink-0">
              ...
              >
                <defs>
                  <linearGradient id="rewardsGiftGradDesk" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#F59E0B" />
                    <stop offset="30%" stopColor="#EF4444" />
                    <stop offset="70%" stopColor="#EC4899" />
                    <stop offset="100%" stopColor="#8B5CF6" />
                  </linearGradient>
                  <linearGradient id="rewardsRibbonGradDesk" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#FCD34D" />
                    <stop offset="100%" stopColor="#F59E0B" />
                  </linearGradient>
                </defs>
                <rect x="3" y="8.5" width="18" height="11.5" rx="2" fill="url(#rewardsGiftGradDesk)" />
                <rect x="2" y="5" width="20" height="4" rx="1.5" fill="url(#rewardsGiftGradDesk)" filter="brightness(1.15)" />
                <rect x="10.5" y="5" width="3" height="15" fill="url(#rewardsRibbonGradDesk)" />
                <rect x="2" y="6.2" width="20" height="1.6" fill="url(#rewardsRibbonGradDesk)" opacity="0.85" />
                <path d="M12 5.2C10.2 2.2 6.5 1.8 6.5 3.8C6.5 5.5 10.5 5.2 12 5.2Z" fill="url(#rewardsRibbonGradDesk)" />
