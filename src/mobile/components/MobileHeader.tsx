...
export default function MobileHeader({ onOpenSearch, onOpenNotifications }: MobileHeaderProps) {
  ...
  const getPageTitle = () => {
    ...
    if (path.startsWith('/deal259')) return 'Deal 259';
    if (path.startsWith('/offers')) return 'Special Offers';
  ...
  return (
    <header className="sticky top-0 z-40 bg-primary backdrop-blur-md border-b border-emerald-800/40 shadow-sm transition-all" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          {!isHomePage ? (
            ...
            <motion.button
              ...
              className="flex items-center gap-1 bg-yellow-50/90 px-2.5 py-1 rounded-full text-left max-w-[180px] min-w-0"
            >
