...
export default function MobileCategoriesScreen() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF3EB] pb-24 font-sans select-none flex flex-col">
      {/* Top Header Banner */}
      <div className="bg-gradient-to-r from-emerald-800 via-emerald-700 to-orange-600 p-4 text-white shadow-md">
      ...
      <div className="flex-1 flex overflow-hidden min-h-[70vh]">
        ...
        <div className="w-28 bg-white border-r border-orange-100/80 overflow-y-auto hide-scrollbar py-2 space-y-1.5 shrink-0">
          {categories.map((cat) => {
              ...
              <motion.button
                ...
                className={`w-full p-2.5 flex flex-col items-center justify-center text-center transition-all relative ${
                  isActive
                    ...
                    : 'text-gray-600 hover:bg-orange-50/40 font-semibold'
                }`}
              >
                {isActive && (
                  <motion.div
                ...
                <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-1 overflow-hidden transition-all ${
                  isActive ? 'bg-blue-600 text-white shadow-md scale-105' : 'bg-gray-100 border border-gray-200/60'
                }`}>
                  {cat.image ? (
          ...
          {selectedCategory && (
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="bg-white rounded-[22px] p-3.5 shadow-sm border border-orange-100 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-2xl bg-orange-50 border border-orange-200 overflow-hidden shrink-0">
                      <img 
                ...
                {selectedCategory.subcategories && selectedCategory.subcategories.length > 0 ? (
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      {selectedCategory.subcategories.map((sub) => (
                        <motion.div
                          ...
                          className="bg-white rounded-[20px] p-3 border border-orange-100/90 shadow-sm flex flex-col items-center justify-center text-center cursor-pointer hover:shadow-md hover:border-emerald-300 transition-all group"
                        >
                  ...
                  <div className="bg-white rounded-[22px] p-6 text-center border border-orange-100 space-y-2">
