...
import returnRequestHandler from "./_handlers/returns/request";
import refundRequestHandler from "./_handlers/refunds/request";
import updateStatusHandler from "./_handlers/requests/update-status";
import sendEmailOtpHandler from "./_handlers/auth/send-email-otp";
import verifyEmailOtpHandler from "./_handlers/auth/verify-email-otp";
import deliveryNotificationHandler from "./_handlers/notifications/delivery";
import registerTokenHandler from "./_handlers/push/register-token";
import sendNotificationHandler from "./_handlers/notifications/send";
import campaignsHandler from "./_handlers/campaigns/manage";
import trackNotificationHandler from "./_handlers/notifications/track";
import segmentsHandler from "./_handlers/segments/index";
